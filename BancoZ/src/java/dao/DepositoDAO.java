        ...
        try {
            ...
            if (resultado != null) {
                while (resultado.next()) {
                    ...
                    deposito.setCpfdoremetente(Integer.parseInt(resultado.getString("CPF_ORIGEM")));
                    deposito.setCpfdoremetente(Integer.parseInt(resultado.getString("NOME_ORIGEM")));
                    deposito.setIdcontadoremetente(Integer.parseInt(resultado.getString("CONTA_ORIGEM")));
                    deposito.setContadobeneficiado(Integer.parseInt(resultado.getString("CONTA_DESTINO")));
                    deposito.setValor(resultado.getDouble("VALOR_DEPOSITO"));
                    deposito.setAgencia(Integer.parseInt(resultado.getString("AGENCIA")));
